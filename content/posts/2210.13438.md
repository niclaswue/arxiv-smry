...
UseHugoToc: false
cover:
    image: "https://ik.imagekit.io/smryai/2210-13438v1_jAFztH6Vs.jpg" # image path/url
...
- Transformer models can be used to further compress the obtained representation by up to 40% while staying faster than real time
...
- The model consists of 5 layers, 8 heads, 200 channels, and a dimension of 800 for the feed-forward blocks
...
- Annotators were recruited using a crowd-sourcing platform.
...
- EnCodec can be reduced in bandwidth by ∼ 25 − 40% when considering a language model and entropy coding
- Streamable vs. non-streamable setups have a small degradation in performance, but the impact of the balancer is significant
